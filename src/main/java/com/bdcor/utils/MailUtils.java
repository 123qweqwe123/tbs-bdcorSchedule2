...
public class MailUtils {
    ...
    public static void sendMail(String toMail,String title,String content){
        try{
            ...
            props.put("mail.smtp.host", "smtp.jnyl-tech.com");
            // 发件人的账号
            props.put("mail.user", "zabbix@jnyl-tech.com");
            // 访问SMTP服务时需要提供的密码
            props.put("mail.password", "Zabbix@genertech");
    ...
    */
            ...
            String content2 = content.replaceAll(System.lineSeparator(), "<br>");
            // 设置邮件的内容体
